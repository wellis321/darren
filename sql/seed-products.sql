-- Seed products (run if table exists but is empty)
-- mysql -u user -p YOUR_DB_NAME < sql/seed-products.sql
-- Or in phpMyAdmin: select your database, then run this.

INSERT IGNORE INTO products (slug, title, description, price, image_url, category, sizes, is_featured, sort_order) VALUES
